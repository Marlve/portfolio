  ...
  return (
    <header className="py-4 grid grid-cols-2 select-none sticky top-0 bg-background z-10">
      ...
      <div className="justify-self-end w-1/6 self-end mb-2 text-end">
        <a href="mailto:derichmedia@gmail.com" className="border border-white rounded-md px-2 py-2 transition duration-500 ease-in-out hover:border-blue-600 hover:text-blue-600">Contact Me</a>
      </div>
    </header>
  )
}
